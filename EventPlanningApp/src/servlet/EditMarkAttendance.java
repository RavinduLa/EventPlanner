 ...
 */
@WebServlet("/edit")
public class EditMarkAttendance extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditMarkAttendance() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		attendee.setATTENDANCE(request.getParameter("attendanceSelect"));
		System.out.println("Attendence" + request.getParameter("attendanceSelect"));
		att.updateAttandee(attendee);
